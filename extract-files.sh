...
function blob_fixup() {
    ...
    vendor/lib/libtinyalsa-moto.so)
        ...
        ;;
    # rename moto modified tinyalsa
    vendor/lib/hw/audio.primary.lito-moto.so | vendor/lib/hw/sound_trigger.primary.lito.so | vendor/lib/soundfx/libmmieffectswrapper.so | vendor/lib/soundfx/libspeakerbundle.so)
